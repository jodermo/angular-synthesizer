...
import { SynthesizerLfo } from './synthesizer-lfo';
import { ChangeDetectorRef, Injectable } from '@angular/core';
import { SynthesizerManager } from './synthesizer-manager';
...
export class Synthesizer {
  ...
  constructor(public oscCount: number, public lfoCount: number, public sequencerCount: number, private changeDetector: ChangeDetectorRef) {
    this.restart();
    ...
    //this.manager.getLocalStorage(this);
